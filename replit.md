...
- **Profile Picture System**: Selfie capture for Nate's aging documentation project. Tapping the profile avatar auto-opens the front-facing camera. Photos are stored locally and sent to ZEKE with tags ["profile-picture", "aging-documentation", "selfie"]. Includes 7-14 day reminder system (random interval) with visual badge indicator when it's time to take a new photo.
